...
In the next video we will be using a font/icon library called Font Awesome. Font Awesome can now be found at https://fontawesome.com/

I recommend using the following CDN link for the latest version:
...
Meanwhile, if you're using Glyphicons instead of Font Awesome, but the icons aren't showing up and a rectangle shows instead, then see here.

Lastly, if your hamburger menu button is broken and you're using jQuery 3.5.0 then please upgrade to 3.5.1:

<script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha256-9/aliU8dGd2tb6OSsuzixeV4y/faTqgFtohetphbbj0=" crossorigin="anonymous"></script>


<!-- Kit code for fontAwesome -->
<script src="https://kit.fontawesome.com/b552585cfa.js" crossorigin="anonymous"></script>