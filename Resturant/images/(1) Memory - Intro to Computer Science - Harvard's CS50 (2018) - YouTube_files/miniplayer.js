...
I:"ytp-miniplayer-ui"});this.player=a;this.H=!1;this.G=this.w=this.u=void 0;this.L(a,"minimized",this.eI);this.L(a,"onStateChange",this.OO)},Q5=function(a){g.gM.call(this,a);
...
g.h.show=function(){this.u=new g.zn(this.dI,null,this);this.u.start();if(!this.H){this.C=new g.mR(this.player,this);g.C(this,this.C);g.UL(this.player,this.C.element,4);this.C.B=.6;this.R=new g.mQ(this.player);g.C(this,this.R);this.A=new g.V({D:"div",I:"ytp-miniplayer-scrim"});g.C(this,this.A);this.A.ba(this.element);this.L(this.A.element,"click",this.IA);var a=new g.V({D:"button",Y:["ytp-miniplayer-close-button","ytp-button"],M:{"aria-label":"Close"},K:[g.KM()]});g.C(this,a);a.ba(this.A.element);
this.L(a.element,"click",this.fz);a=new O5(this.player,this);g.C(this,a);a.ba(this.A.element);this.B=new g.V({D:"div",I:"ytp-miniplayer-controls"});g.C(this,this.B);this.B.ba(this.A.element);this.L(this.B.element,"click",this.IA);var b=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,b);b.ba(this.B.element);a=new g.V({D:"div",I:"ytp-miniplayer-play-button-container"});g.C(this,a);a.ba(this.B.element);var c=new g.V({D:"div",I:"ytp-miniplayer-button-container"});g.C(this,c);c.ba(this.B.element);
...
"ytp-button"],M:{"aria-label":"Close"},K:[g.KM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.fz);a=new g.V({D:"button",Y:["ytp-miniplayer-replay-button","ytp-button"],M:{"aria-label":"Close"},K:[g.ZM()]});g.C(this,a);a.ba(this.F.element);this.L(a.element,"click",this.DM);this.L(this.player,"presentingplayerstatechange",this.fI);this.L(this.player,"appresize",this.Gs);this.L(this.player,"fullscreentoggled",this.Gs);this.Gs();this.H=!0}0!=this.player.getPlayerState()&&g.V.prototype.show.call(this);
...
g.h.fz=function(){this.player.stopVideo();this.player.ma("onCloseMiniplayer")};
g.h.DM=function(){this.player.playVideo()};
g.h.IA=function(a){if(a.target==this.A.element||a.target==this.B.element)g.Q(this.player.N().experiments,"kevlar_miniplayer_play_pause_on_scrim")?g.BD(g.CL(this.player))?this.player.pauseVideo():this.player.playVideo():this.player.ma("onExpandMiniplayer")};
g.h.eI=function(){g.K(g.AL(this.player),"ytp-player-minimized",this.player.app.G.o)};
g.h.dI=function(){g.RN(this.w);this.G.w();this.u&&this.u.start()};
g.h.fI=function(a){g.W(a.state,32)&&this.C.hide()};
g.h.Gs=function(){var a=this.w,b=g.zL(this.player).getPlayerSize().width;a.Ea=0;a.C=b;a.B=!1;g.TN(a);this.w.ru()};
...
g.h.Mh=function(){};
g.h.nk=function(){};
g.h.pl=function(){return null};
g.h.Fs=function(){return new g.th(0,0,0,0)};
